...
// Question 1
document.getElementById('host-name').textContent = 'A';
document.getElementById('collaborator-name').textContent = 'B';
document.getElementById('collaborator-2-name').textContent = 'C';
